...
REPO_DIR = "/home/diniz/boilerplate-fastapi-postgres"

# Caminho para a pasta do docker-compose.yml
DOCKER_COMPOSE_DIR = "/home/diniz/boilerplate-fastapi-postgres"

# Nome da imagem e do container Docker
IMAGE_NAME = "boilerplate-fastapi-postgres-python-back"
CONTAINER_NAME = "app-backend"

def run_command(command, cwd=None):
    """Executa um comando shell e imprime a saída."""
    result = subprocess.run(command, shell=True, cwd=cwd, text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
